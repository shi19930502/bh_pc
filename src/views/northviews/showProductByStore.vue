      ...
      <div class="store-info min-width flex flex-x-between">
        <div class="flex flex-y-center">
          ...
          <div class="store-pingfen flex flex-y-center">
            <span class="lookpj" @click="toevalist(storeInfo)">信用等级</span>：
            ...
            <ul v-if="categoryList.length>0">
              ...
              <li v-for="d in categoryList">
                <div
                  ...
                  @click="categoryChange(d.gbgoodsId,d.name)"
                >
                  <div class="flex flex-y-center">
        ...
        <div class="right">
          ...
          <div class="pro-list-wrapper">
            <ul class="pro-list flex" v-if="productList.length>0">
              <li v-for="d in productList" :style="liheight">
                <div class="item">
                  <div class="pro-img">
                  ...
                  <div class="pro-text">
                    <div class="pro-price flex flex-x-between flex-y-center">
                      <div class="p1">
                        <span
                          v-if="d.isPomotion==1 && d.promotionalPricing!='' && d.promotionalPricing!=null"
                        >{{'￥'+d.promotionalPricing.toFixed(2)}}</span>
                        <template v-else>
                          <span
                    ...
                    <div
                      class="pro-btns flex flex-y-center"
                      v-if="(userInfo.userType=='003' && type == '003') || storeInfo.sellerId == 1"
                    >
                      <div
...
import { Pagination, Rate, Dialog } from "element-ui";
...
export default {
  ...
  data() {
    return {
      ...
      storeInfo: {},
      liheight:
        (JSON.parse(localStorage.getItem("userInfo")).userType == "003" &&
        this.$route.query.type == "003")|| this.$route.query.sellerId ==1
          ? "height: 300px;"
          : "height: 260px;",
      type: "001"
    };
  ...
  methods: {
    ...
    getProductList() {
      ...
      // if (this.userInfo && (this.userInfo.userType == "003"||this.userInfo.userType == "002"||this.userInfo.userType == "004")) { /** 自营平台需求变更 002 004还是在一批处购买 */
      //   // 自营平台
