    ...
    <div style="background: #F1F1F1;">
              ...
              <el-table-column label="趋势">
                <template slot-scope="scope">
                  <img
                    ...
                    src="../../../static/img/northring/down.png"
                    alt
                  >
      ...
      <template v-else>
        <section class="current-store min-width">
          <div class="title-wrap flex flex-y-center flex-x-between">
            <div class="flex">
              <div class="title-icon"></div>
              <div class="title-text">
                <p>店铺列表</p>
            ...
            <!-- 搜索 -->
            <div style="margin: 15px 0;width: 360px;">
              <el-input
                placeholder="搜索店铺"
                v-model="searchVal"
                ...
                <ul class="store-list" v-if="stores.length>0">
                  <li v-for="d in stores" class="flex">
                    <div class="store-info">
                      ...
                      >{{(d.distatce/1000).toFixed(1)}}km</div>
...
export default {
  ...
  async created() {
    ...
    this.AddressInfo = await this.getUserAddressInfo();
    // this.getUserMessage()
    if (!this.isLogin) {
  ...
  methods: {
    ...
    getStoreByChannel() {
      ...
      if (this.userInfo) {
        if (this.AddressInfo) {
          param.latitude = this.AddressInfo.latitude;
          param.longitude = this.AddressInfo.longitude;
        }
      }
