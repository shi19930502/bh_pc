<template>
	<div id="feedback">
		<div class="navbar flex flex-y-center">意见反馈</div>
		<div class="main">
			<div class="title-text">欢迎向银川公益农产反馈</div>
			<div class="group">
				<strong>1.反馈标题</strong>
				<div class="sinput">
					<el-input size="small" placeholder="请输入内容"></el-input>
				</div>
			</div>
			<div class="group">
				<strong>2.反馈内容</strong>
				<div class="sinput">
			...
			<div class="group">
				<strong>3.联系方式(推荐手机)</strong>
				<div class="sinput">
					<el-input size="small" placeholder="请输入内容"></el-input>
				</div>
			</div>
			<div class="sbtn">
				<shop-btn height="30px" bgcolor="#FF4400" border="1px #FF4400" color="#fff" fontsize="14px" text="提交"></shop-btn>
			</div>
		</div>
	</div>
</template>
