      ...
      <div class="min-width">
        ...
        <div class="pjcontent flex">
          ...
          <div class="right flex flex-x-center">
            <p>订单评价</p>
            <el-input v-if="type == 1" readonly type="textarea" :rows="5" placeholder="请输入内容" v-model="reviewContent" style="width: 684px;height: 126px;">
            </el-input>
            <el-input v-else type="textarea" :rows="5" placeholder="请输入内容" v-model="reviewContent" style="width: 684px;height: 126px;">
            </el-input>
          </div>
        </div>

        <div class="savebtn flex flex-x-center flex-y-center">
          <shop-btn v-if="type==1" @click.native="$router.back" marginR="10px" text="返回" bgcolor="#F64811" border="1px #F64811" color="#fff"
            height="46px" width="220px"></shop-btn>

          <shop-btn v-else @click.native="save" marginR="10px" text="提交" bgcolor="#F64811" border="1px #F64811" color="#fff" height="46px"
